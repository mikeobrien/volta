...
namespace Volta.Web
{
    public class TestUrlPolicy : IUrlPolicy
    {
        ...
        private readonly List<UrlPolicy.ModifyRouteStrategy> _modifications = new List<UrlPolicy.ModifyRouteStrategy>();

        private readonly IRouteInputPolicy _routeInputPolicy;

        public TestUrlPolicy(Func<ActionCall, bool> filter, IRouteInputPolicy routeInputPolicy)
        {
            _filter = filter;
        ...
        {
            _modifications.Add(new UrlPolicy.ModifyRouteStrategy{
                Filter = filter,
                Modify = modification
            });
        }
