...
namespace Volta.Tests.Unit.UserInterface.Behaviors
{
    ...
    public class AuthorizationBehaviorTests
    {
        ...
        public void when_logged_in_should_continue()
        {
            ...
            var behavior = new AuthorizationBehavior(outputWriter, actionBehavior, secureSession, webServer);
            behavior.Invoke();
        ...
        public void when_not_logged_in_should_return_a_401()
        {
            ...
            outputWriter.Received().WriteResponseCode(HttpStatusCode.Unauthorized, AuthorizationBehavior.UnauthorizedMessage);
        }
    }
}